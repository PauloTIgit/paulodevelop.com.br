...
if ($imagens != []) {
    $about = $imagens['about'];
    $makefilx = $imagens['makefilx'];
    $personal = $imagens['personal'];
    $autoCar = $imagens['autoCar'];
...
<main class="view" id="view">
    <!------------------------------------------------ HOME  -->
    <section class="container-home infinity" id="home">
    ...
    <!------------------------------------------------ ABOUT  -->
    <section class="container-about infinity" id="about">
        <div class="box-about">
