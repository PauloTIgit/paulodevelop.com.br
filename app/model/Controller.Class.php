...
class Controller
{
    ...
    /////////////////////// METHOD = SETTINGS
        /////////////////////// SETTING
            ...
            {
                $perfil = 'src/image/perfil/perfil.jpg';
                $about = 'src/image/perfil/about.jpg';
                $makefilx = 'src/image/portfolio/makeflix.png';
                $personal = 'src/image/portfolio/thalispersonal.png';
                $autoCar = 'src/image/portfolio/auto.png';
                $coockie = 'src/image/data/coockie.png';
                $c_basic = 'src/image/certificado/c_Basic.png';
                $loading = 'src/image/loading/loading.gif';
                $maintenance = 'src/image/maintenance/manutencao.gif';
                $result = [
                    'perfil'        =>      $perfil,
                    'about'         =>      $about,
                    'makefilx'      =>      $makefilx,
